<p align="center">
  ...
  <a href="https://www.npmjs.com/package/@universal-form/core"><img src="https://img.shields.io/npm/v/@universal-form/core?style=flat-square&color=blue" alt="npm version" /></a>
  <img src="https://img.shields.io/npm/dm/@universal-form/core?style=flat-square&color=green" alt="downloads" />
  <img src="https://img.shields.io/bundlephobia/minzip/@universal-form/core?style=flat-square&color=orange" alt="bundle size" />
  ...
  <a href="./LICENSE"><img src="https://img.shields.io/npm/l/@universal-form/core?style=flat-square" alt="license" /></a>
...
```bash
# Core packages
npm install @universal-form/core @universal-form/react @universal-form/zod

# Choose your form engine adapter
npm install @universal-form/react-hook-form react-hook-form
# or
npm install @universal-form/formik formik
# or
npm install @universal-form/tanstack-form @tanstack/react-form
```
...
// or: import { formikAdapter } from '@universal-form/formik';
// or: import { tanstackAdapter } from '@universal-form/tanstack-form';
...
```tsx
import { useUniversalForm, Field } from '@universal-form/react';
...
| --------------------------------------------------------------- | ------------------------------------- | -------------------------------------------------------------------------------------------------------- |
| [`@universal-form/core`](./packages/core)                       | Core types, utilities, and interfaces | ![](https://img.shields.io/bundlephobia/minzip/@universal-form/core?style=flat-square&label=)            |
| [`@universal-form/react`](./packages/react)                     | React hooks and components            | ![](https://img.shields.io/bundlephobia/minzip/@universal-form/react?style=flat-square&label=)           |
| [`@universal-form/react-hook-form`](./packages/react-hook-form) | React Hook Form adapter               | ![](https://img.shields.io/bundlephobia/minzip/@universal-form/react-hook-form?style=flat-square&label=) |
| [`@universal-form/formik`](./packages/formik)                   | Formik adapter                        | ![](https://img.shields.io/bundlephobia/minzip/@universal-form/formik?style=flat-square&label=)          |
| [`@universal-form/tanstack-form`](./packages/tanstack-form)     | TanStack Form adapter                 | ![](https://img.shields.io/bundlephobia/minzip/@universal-form/tanstack-form?style=flat-square&label=)   |
| [`@universal-form/zod`](./packages/zod)                         | Zod schema bridge                     | ![](https://img.shields.io/bundlephobia/minzip/@universal-form/zod?style=flat-square&label=)             |
